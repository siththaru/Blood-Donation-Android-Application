...
public class FamilyTabFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup root = (ViewGroup) inflater.inflate(R.layout.family_tab_fragment, container, false);
        ...
        txtContact = root.findViewById(R.id.contact);
        bloodGrp = root.findViewById(R.id.SpinnerBlood);
            ...
            btnpost.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(txtContact.getText().length() != 10) {
                        Toast.makeText(getActivity(), "Enter a valid contact number!", Toast.LENGTH_LONG).show();
                        pd.dismiss();
                    }
                        ...
                        findname.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    db_ref.child(uid).child("Myfamily").child("Name").setValue(dataSnapshot.getValue(UserData.class).getName());
                                    db_ref.child(uid).child("Myfamily").child("Contact").setValue(txtContact.getText().toString());
                                    db_ref.child(uid).child("Myfamily").child("Latitude").setValue(latitude);
                                    db_ref.child(uid).child("Myfamily").child("Longitude").setValue(longitude);
                                    db_ref.child(uid).child("Myfamily").child("BloodGroup").setValue(bloodGrp.getSelectedItem().toString());
                                    db_ref.child(uid).child("Myfamily").child("Time").setValue(Time);
                                    db_ref.child(uid).child("Myfamily").child("Date").setValue(Date);
